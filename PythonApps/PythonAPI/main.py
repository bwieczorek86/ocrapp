...
@app.get("/convert-pdf-get")
async def convert_pdf_to_image():
    try:
        with tempfile.TemporaryDirectory() as path:
            images_from_path = convert_from_path("C:\\Users\\bwita\\OneDrive\\Desktop\\Prezentacja\\Wszsczęcie egzekucji\\Skan (13).pdf", output_folder=path, last_page=1, first_page=0)

            for page in images_from_path:
                page.save("C:\\Users\\bwita\\OneDrive\\Desktop\\Prezentacja\\Wszsczęcie egzekucji\\Skan (13).jpg", 'JPEG')
...
async def convert_pdf_to_image():
    try:
        with tempfile.TemporaryDirectory() as path:
            images_from_path = convert_from_path("C:\\Temp\\re\\Skan (13).pdf", output_folder=path, last_page=1, first_page=0)

            for page in images_from_path:
                page.save("C:\\Temp\\re\\Skan (13).jpg", 'JPEG')
